...
import DomeGallery from "../../layout/animation/dome/DomeGallery";
...
const TestimonialsSection = () => {
  ...
  return (
    <>
      {/* New section above testimonials with same sizing, containing DomeGallery */}
      <section
        ref={experienceRef}
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-dark-600 max-w-3xl mx-auto font-medium">
            Những trải nghiệm thực tế của các học viên đã thành công với chúng
            tôi
          </p>
        </div>
