...
const DEFAULT_IMAGES: ImageItem[] = [
  {
    src: "https://images.unsplash.com/photo-1593055541433-49584940844e?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2940",
    alt: "Abstract art",
  },
  {
    src: "https://images.unsplash.com/photo-1721097777541-eb4bdfe6719d?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2940",
    alt: "Modern sculpture",
  },
  {
    src: "https://images.unsplash.com/photo-1607309661874-cbca4c0e8682?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2940",
    alt: "Digital artwork",
  },
  {
    src: "https://images.unsplash.com/photo-1515651513386-89be725f1571?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2878",
    alt: "Contemporary art",
  },
  {
    src: "https://images.unsplash.com/photo-1576610616656-d3aa5d1f4534?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1470",
    alt: "Geometric pattern",
  },
  {
    src: "https://images.unsplash.com/photo-1599376871063-1b999e42afde?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2940",
    alt: "Textured surface",
  },
  {
    src: "https://images.unsplash.com/photo-1530138897365-a9615c610099?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2080",
...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const tick = (ts: number) => {
      const deltaSeconds = Math.max(0, (ts - lastTs) / 1000);
      lastTs = ts;
      const isBusy =
        draggingRef.current ||
      ...
      if (!isBusy) {
        const nextY = wrapAngleSigned(
          rotationRef.current.y + autoRotateSpeedDegPerSec * deltaSeconds
        );
  ...
  }, [autoRotate, autoRotateSpeedDegPerSec]);
